...
public class RedisUtils {
     ...
     * @param timeout
     * @param timeUnit
     * @return 如果setnx成功设置了key,那么就返回true,如果redis中key已经存在,setnx返回false
     */
     ...
     * @return
     */
    public Object execLuaScript(String script, List<Object> keys,Class<?> resultCls,Object...args) {
